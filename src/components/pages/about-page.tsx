...
export function AboutPage() {
  ...
  const values = [
    ...
    {
      t: "Outcome obsessed",
      p: "We measure ourselves by your time-to-hire and offer-accept rate.",
    },
  ];
      ...
      <section className="pt-16 pb-20 sm:pt-24">
        <div className="container-x reveal text-center">
          ...
          <h1 className="mt-5 text-4xl font-black sm:text-6xl">
            Hiring, rebuilt around the people doing it.
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-muted-foreground">
            We started Aigent because the best recruiters were drowning in dashboards. So we built
            an AI teammate that handles the busywork — and amplifies their craft.
          </p>
        </div>
      </section>
        ...
        <div className="container-x grid gap-10 lg:grid-cols-2">
          <div className="reveal">
            ...
            <p className="mt-5 text-muted-foreground">
              Founded in 2022 in Bristol, Aigent grew from a small research project into a
              recruiting platform trusted by teams in 180+ countries. We obsess over one number: the
              time between a job opening and a great hire saying yes.
            </p>
            <p className="mt-4 text-muted-foreground">
              Today our team spans engineering, talent science, and design — united by a belief that
              great hiring is great storytelling.
            </p>
          </div>
